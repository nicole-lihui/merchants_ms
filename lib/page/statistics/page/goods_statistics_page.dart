...
import 'package:merchant_ms/util/date_utils.dart';
...
import 'package:merchant_ms/widgets/pie_chart/pie_chart.dart';
import 'package:merchant_ms/widgets/pie_chart/pie_data.dart';
import 'package:merchant_ms/widgets/selected_text.dart';
...
class _GoodsStatisticsPageState extends State<GoodsStatisticsPage> {
  ...
  _buildSelectedText(String text, int index) {
    Color unSelectedTextColor =
        ThemeUtils.isDark(context) ? Colors.white : Colours.dark_text_gray;
    return SelectedText(
      text,
