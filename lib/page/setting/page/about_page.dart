      ...
      body: Column(
        children: <Widget>[
          ...
          ClickItem(
            title: 'Github',
            content: 'Go Star',
            onTap: () => NavigatorUtils.goWebViewPage(context, 'Merchants MS', 'https://github.com/nicole-lihui/merchants_ms')
          ),
          ClickItem(
            title: '作者',
            onTap: () => NavigatorUtils.goWebViewPage(context, '作者博客', 'https://nicole-lihui.github.io')
          ),
        ],
      ),
    );
