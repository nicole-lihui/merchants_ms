                  ...
                  child: Semantics(
                    ...
                    child: GestureDetector(
                      ...
                      child: const SizedBox(
                          ...
                          width: 16.0,
                          child:
                              const LoadAssetImage('goods/icon_dialog_close')),
                    ),
                  ),
                ),
              ],
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border:
                          Border.all(width: 0.6, color: Colours.text_gray_c),
                    ...
                    child: InkWell(
                      child: Center(
                        child: index == 11
                            ? Semantics(
                                label: '删除',
                                child: const LoadAssetImage('account/del',
                                    width: 32.0))
                            : index == 9
                                ? Semantics(label: '无效', child: Gaps.empty)
