...
import 'package:merchant_ms/page/account/models/bank_model.dart';
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtils.pushResult(
                                  context, AccountRouter.citySelectPage,
                                  (result) {
                                setState(() {
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtils.pushResult(context,
                                  '${AccountRouter.bankSelectPage}?type=0',
                                  (result) {
                                setState(() {
                          ...
                          StoreSelectTextItem(
                            ...
                            onTap: () {
                              NavigatorUtils.pushResult(context,
                                  '${AccountRouter.bankSelectPage}?type=1',
                                  (result) {
                                setState(() {
                                  BankModel model = result;
