...
class AccountRouter implements IRouterProvider {
  ...
  void initRouter(Router router) {
    ...
    router.define(accountRecordListPage,
        handler: Handler(handlerFunc: (_, params) => AccountRecordListPage()));
    router.define(addWithdrawalAccountPage,
        handler:
            Handler(handlerFunc: (_, params) => AddWithdrawalAccountPage()));
    ...
    router.define(citySelectPage,
        handler: Handler(handlerFunc: (_, params) => CitySelectPage()));
    router.define(withdrawalAccountListPage,
        handler:
            Handler(handlerFunc: (_, params) => WithdrawalAccountListPage()));
    router.define(withdrawalAccountPage,
        handler: Handler(handlerFunc: (_, params) => WithdrawalAccountPage()));
    router.define(withdrawalPage,
        handler: Handler(handlerFunc: (_, params) => WithdrawalPage()));
    router.define(withdrawalPasswordPage,
        handler: Handler(handlerFunc: (_, params) => WithdrawalPasswordPage()));
    router.define(withdrawalRecordListPage,
        handler:
            Handler(handlerFunc: (_, params) => WithdrawalRecordListPage()));
    router.define(withdrawalResultPage,
        handler: Handler(handlerFunc: (_, params) => WithdrawalResultPage()));
  }
}
