...
class GoodsRouter implements IRouterProvider {
  ...
  void initRouter(Router router) {
    router.define(goodsPage,
        handler: Handler(handlerFunc: (_, params) => GoodsPage()));
    ...
    router.define(goodsSearchPage,
        handler: Handler(handlerFunc: (_, params) => GoodsSearchPage()));
    router.define(goodsSizePage,
        handler: Handler(handlerFunc: (_, params) => GoodsSizePage()));
    router.define(goodsSizeEditPage,
        handler: Handler(handlerFunc: (_, params) => GoodsSizeEditPage()));
  }
}
